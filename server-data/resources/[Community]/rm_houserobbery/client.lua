...
AddEventHandler('lto_houserobbery:crochetage', function()
	...
	Citizen.Wait(50)
	 ...
	 local Try1 = exports["syn_minigame"]:taskBar(3400,25)
    ...
    local Try5
     Wait(1000)
    if Try1 == 100 then
    Try2 = exports["syn_minigame"]:taskBar(3400,19)
    end
    Wait(1000)
    if Try2 == 100 then
    Try3 = exports["syn_minigame"]:taskBar(3400,18)
    end
	TaskPlayAnim(playerPed, "script_common@jail_cell@unlock@key", "action", 8.0, -0.5, -1, 0, 0, true, 0, false, 0, false)
    Wait(1000)
    if Try3 == 100 then
	Try4 = exports["syn_minigame"]:taskBar(3400,15)
    end
    Wait(1000)	
	if Try4 == 100 then
	Try5 = exports["syn_minigame"]:taskBar(3400,20)
     end
    Wait(1000)	
	if Try5 == 100 then	
	TriggerEvent("vorp:TipBottom", Config.Language.houseunlocked, 1000)
...
RegisterNetEvent('lto_houserobbery:policenotify')
AddEventHandler('lto_houserobbery:policenotify', function()	
    local playerPed = PlayerPedId()
    local coords = GetEntityCoords(playerPed)
	TriggerServerEvent("lto_houserobbery:policenotify", GetPlayers(), coords) -- averti les sherif
end)
