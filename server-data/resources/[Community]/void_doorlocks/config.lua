Config = {}
Config.useitems = false --if true you can open doors using authorizedItems (authorizedJobs will be neglected)
...
-- Double doors Example END
	...
	{
		authorizedJobs = { 'police','sheriff' }, -- vector3(1282.31, -1308.41, 77.04)
