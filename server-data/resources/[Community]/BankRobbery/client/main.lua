...
RegisterNetEvent("Witnesss:ToggleNotification3")
AddEventHandler("Witnesss:ToggleNotification3", function(coords, alert)
	--print('store name '..tostring(alert))
	TriggerEvent("vorp:TipBottom", 'Robbery  in  Progress at ' .. alert, 15000)
...
AddEventHandler('mushy_robbery:startAnimation2', function(num,typey)	
	...
	local playerPed = PlayerPedId()
	local coords = GetEntityCoords(playerPed)
    local testplayer = exports["syn_minigame"]:taskBar(4000,20)
    local testplayer2
    local testplayer3
    local testplayer4
    Wait(1000)
    if testplayer == 100 then
    testplayer2 = exports["syn_minigame"]:taskBar(3500,20)
    end
    Wait(1000)
    if testplayer2 == 100 then
    testplayer3 = exports["syn_minigame"]:taskBar(3200,25)
    end
    Wait(1000)
    if testplayer3 == 100 then
    testplayer4 = exports["syn_minigame"]:taskBar(2900,30)
    end
