            ...
            wheels = {                              -- Array of wheels to display
                {
                    ...
                    labels = { "Stop Anim", "Other", "Reload Char", "Clothing", "Walk Style", "Animations", "Scenarios" },
                    commands = { "sa", "other", "rc", "clothingmenu", "walkstyle", "animations",  "submenu7"}
            ...
            wheels = {
                {
                    ...
                    labels = {"Hud", "Flip Coin", "Forecast" },
                    commands = {"hideUi", "flipcoin", "forecast"}
                    ...
                    -- commands = {"hideUi", "dh", "dv", "dcampfire", "dtent", "flipcoin", "forecast", "togglechat", "race", "rps", "plant_load", "he"}
                },
