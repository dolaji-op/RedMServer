...
if IsPlayerNearCoords(-814.99, -1313.581, 43.68) then
    ...
    elseif rnd <=50 then
                    TaskStartScenarioAtPosition(PlayerPedId(), GetHashKey('PROP_HUMAN_PIANO_UPPERCLASS'), -814.99 - 0.03, -1313.581 + 0.5, 43.68 - 0.53, 359.25, duration, true, true, 0, true)
    elseif rnd <=75 then
                    TaskStartScenarioAtPosition(PlayerPedId(), GetHashKey('PROP_HUMAN_PIANO_RIVERBOAT'), -814.99 - 0.03, -1313.581 + 0.5, 43.68 - 0.53, 359.25, duration, true, true, 0, true)
    else
        TaskStartScenarioAtPosition(PlayerPedId(), GetHashKey('PROP_HUMAN_PIANO_SKETCHY'), -814.99 - 0.03, -1313.581 + 0.5, 43.68 - 0.53, 359.25, duration, true, true, 0, true)         
    end
