...
-------------------------- Level System Setup ------------------------------------
Config.LevelSystem = false       --Set this true to use the level system, false will disable it
Config.LevelIncreaseperHunt = 1 --This is how much your level will go up per completed hunt
Config.Levels = {
    {
        level = 0,         --Level you have to be at
...
Config.locations = {
    ...
    },
    {
        ...
        GivenItems = {
            {
                name = "legwolfs2", --this is the 2nd item it gives
